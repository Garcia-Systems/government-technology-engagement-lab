...
def test_chapter_13_is_not_implemented():
    root = Path(__file__).parents[1]
    assert not (root / "chapters/chapter-13-closed-integration-scenario.md").exists()
    assert not (root / "src/government_engagement_lab/closed_integration.py").exists()
