...
def test_chapter_14_is_not_implemented():
    root = Path(__file__).parents[1]
    assert not any((root / "chapters").glob("chapter-14-*"))
    assert not (root / "src/government_engagement_lab/incumbent_vendor_alternative.py").exists()
