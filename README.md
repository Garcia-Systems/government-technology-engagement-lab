...
Chapter 14 asks whether custom software deserves to exist after a serious supported incumbent alternative is considered. **CivicFlow Operations Module, CivicFlow, and every capability, limitation, price, license, service, access, implementation, support, and roadmap statement are wholly fictional `MODELED ALTERNATIVE ASSUMPTION`s and make no claim about a real vendor.**
